...
class createMaterials
	...
	public createMaterials()
	{
		...
		title = new JLabel("Create Materials");
		...
		if (e.getSource() == sub) {
			if (term.isSelected()) {
				...
				String data
					= "Name : "
					+ tname.getText() + "\n";
				String data3 = "Type : " + ttype.getText();
